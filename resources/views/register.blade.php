...
<div id="loader"
    class="d-none position-absolute left-0 top-0 opacity-75 bg-dark z-3 w-100 h-100 d-flex justify-content-center align-items-center">
...
@section('content')
    ...
    <form method="POST" id="user-form">
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="No token" aria-label="token" id="token"
                name="token" disabled>
        </div>
        <div class="input-group mb-3">
        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="input-group mb-3">
                    ...
                    <input maxlength="9" type='text' class="form-control" placeholder="Phone" aria-label="phone"
